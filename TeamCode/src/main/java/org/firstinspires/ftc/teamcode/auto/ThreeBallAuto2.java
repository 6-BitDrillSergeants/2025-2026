...
public class ThreeBallAuto2 extends NextFTCOpMode {
    public final static class AutoPaths {
        ...
        public final AutoPathSpec moveToWall = new AutoPathSpec()
    ...
    private Command autoRoutine() {
        ...
        return new SequentialGroup(
                ...
                new FollowPath(paths.moveToWall.build(follower, GoalConfig.goal))
                );
    }
